...
@section('content')
    ...
    <section class="banner-slider__wrapper banner-slider__wrapper_2 overflow-hidden">
        ...
        <div class="banner-slider_2">
            <div class="slider-item" style="background-image: url({{asset('home/img/home-4/banner_01.png')}});">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="banner__content">
                                ...
                                <h1 class="title color-white mb-sm-30 mb-xs-20 mb-40 text-success" data-animation="fadeInUp" data-delay="1s">
                                    Grow Your Wealth<br> <span class="text-success"> With the Stock market</span></h1>
                                <p class="sub-title color-white mb-15 mb-sm-15 mb-xs-10 text-success">
            ...
            <div class="row">
                ...
                <div class=" col-lg-5 col-md-12 ">
                    <div class="section-title section-title_2">
                        ...
                        <p>
                            Founded in 2013, we are a global investment agency helping individuals build their financial dreams into reality. From a humble beginning, we have grown to become a notable force in the investment industry with over 40K+ users.
                        </p>
                    </div>
